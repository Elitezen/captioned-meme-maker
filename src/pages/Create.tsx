...
export default function Create() {
	...
	useEffect(() => {
		...
		img.onload = () => {
			...
			const wrapAndCenterText = (context: CanvasRenderingContext2D, text: string, x: number, y: number, maxWidth: number) => {
				...
				const lineHeight = img.width * 0.05; // Adjust based on font size
			...
			wrapAndCenterText(ctx, textInput, centerX, centerY, newWidth - (img.width * 0.1));
